...
COPILOTO_SYSTEM_PROMPT = (
    ...
    "- Basate EXCLUSIVAMENTE en los datos proporcionados. No inventes nada.\n"
    "- Si los datos no contienen la respuesta, di claramente: 'No tengo suficiente informacion en los datos proporcionados para responder esa pregunta.'\n"
